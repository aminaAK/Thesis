...
namespace Predictor {
	...
	tuple<Matrix,Matrix> SH_Hybrid2nd(vector<double> V, Zadacha& Z, Vetv& br, long x){
	...
	void Hybrid2nd (Zadacha& Z , Derevo& Tr , Vetv& br){
        ...
        for ( int i = 1; i < (Np - 1); i++ ){
            ...
            out = br.URSOB(VM[0],VM[1], br.ID, T,i);
            P = out[0];
            ...
            out = br.URSOB(VP[0],VP[1], br.ID, T,i);
            P = out[0];
        ...
        for ( int i = 1; i < (Np - 1); i++ ){
            ...
            tie(B_om, D_om) = SH_Hybrid2nd(V_cur, Z,br,i);
            ...
            br.VB[0][i] = V[0];
            br.VB[1][i] = V[1];
            //cout<<"i "<< i<< " br.VB[0][i] "<< br.VB[0][i]<<" ID "<< br.ID<<endl;
